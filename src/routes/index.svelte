...
<main class="sha shadow-lg bg-white p-8 rounded-md">
	...
	<input
		class="rounded-l-lg p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white w-60"
		placeholder="Enter URL Here"
		bind:value={url}
	/>
	<button
		class="px-8 rounded-r-lg bg-blue-400  text-gray-800 font-bold p-4 uppercase border-blue-500 border-t border-b border-r"
		on:click={submitURL}>Generate QR Code</button
	>
	{#if qrCodeDataURL}
